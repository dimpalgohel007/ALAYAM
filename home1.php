...
<form action="">
   <section class="properties container" id="properties">
        <div class="heading">
            <span>Recent</span>
            <h2>Our Available HOME</h2>
            
        </div>
        <div class="properties-container container">
            <!-- Box 1 -->
            <div class="box">
                <a href="pal.php"><img src="img/h1.jpg" alt=""></a>
                <h3>10,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>p-1515,shaktinivas,bhavnagar</p>
                    </div>
                    <div class="icon">
            ...
            <!-- Box 2 -->
            <div class="box">
              <a href="pal.php">  <img src="img/h2.jpg" alt=""></a>
                <h3>12,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>plot-120,maldhari,Sardarnagar</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span></span></i>
                        <i class='bx bx-bath' ><span></span></i>
            ...
            <!-- Box 3 -->
            <div class="box">
               <a href="pal.php"> <img src="img/h3.jpg" alt=""></a>
                <h3>11,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
                        <p>plot-898,kumudvadi,Nilambag</p>
                    </div>
                    <div class="icon">
                        <i class='bx bx-bed' ><span></span></i>
                        <i class='bx bx-bath' ><span></span></i>
