...
<form action="">
   <section class="properties container" id="properties">
        <div class="heading">
            <span>Recent</span>
            <h2>Our Available PG</h2>
            
        </div>
        <div class="properties-container container">
            <!-- Box 1 -->
            <div class="box">
                <a href="pal.php"><img src="img/s1.jpeg" alt=""></a>
                <h3>10,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
            ...
            <!-- Box 2 -->
            <div class="box">
              <a href="pal.php">  <img src="img/s2.jpeg" alt=""></a>
                <h3>12,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
            ...
            <!-- Box 3 -->
            <div class="box">
               <a href="pal.php"> <img src="img/s3.jpeg" alt=""></a>
                <h3>11,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
            ...
            <!-- Box 4 -->
            <div class="box">
			<a href="pal.php"><img src="img/s4.jpeg" alt=""></a>
                <h3>8,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
            ...
            <!-- Box 5 -->
            <div class="box">
               <a href="pal.php"> <img src="img/s5.jpeg" alt=""></a>
                <h3>15,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
            ...
            <!-- Box 6 -->
            <div class="box">
                <a href="pal.php"><img src="img/s6.jpeg" alt=""></a>
                <h3>17,000 rs</h3>
                <div class="content">
                    <div class="text">
                        <h3>The Palace</h3>
